...
- [Resilio Databse](https://db.resilio.tech/): Use state-of-the-art footprint data for IT equipment and infrastructure — from smartphones to virtual machines. The database to plug to your assessment tool or service!
